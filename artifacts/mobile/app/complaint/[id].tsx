...
export default function ComplaintDetailScreen() {
  ...
  const { complaints, tractors } = useApp();

  const complaint = complaints.find(x => x.complaintID === id);
    ...
    return (
      <View style={[styles.root, { backgroundColor: c.background }]}>
        ...
        <View style={styles.empty}>
          ...
          <Text style={[styles.emptyText, { color: c.mutedForeground }]}>Complaint not found</Text>
        </View>
      </View>
    );
  }
  ...
  const meta: { icon: keyof typeof Feather.glyphMap; label: string; value: string }[] = [
    ...
    { icon: 'map-pin', label: 'Plant', value: complaint.plantName || '—' },
